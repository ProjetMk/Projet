...
<div class="section-title">
    ...
    <h3 style="font-size: 24px">{{'Vous avez un '.$BAC.' et vous voulez etre un '.$P_metier.' ou un '.$D_metier.' les différents universités que vous pouvez intégres qui se trouve à '.$ville.' sont les suivantes'}}</h3>
  </div>
	<!-- BEGIN: Content-->
    <div class="container">
